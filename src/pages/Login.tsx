      ...
      <div className="w-full max-w-[420px] relative z-10 px-4 sm:px-0">
        <div className="bg-[var(--surface-1)] border hairline p-6 sm:p-10 shadow-2xl relative overflow-hidden transition-all duration-500">
          ...
          <form className="space-y-5 sm:space-y-6" onSubmit={handleSubmit}>
            ...
            {error && (
              <div className="p-3 bg-[var(--accent-red)]/10 border border-[var(--accent-red)]/20 text-[var(--accent-red)] text-[10px] tracking-[0.1em] font-mono animate-in shake duration-300">
                {error}
              </div>
            )}
            ...
            <button 
              disabled={isLoading}
              className="w-full bg-[var(--primary)] text-[var(--primary-foreground)] py-3.5 sm:py-3 text-[11px] tracking-[0.3em] font-bold hover:opacity-90 transition-all animate-pulse-glow mt-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
        ...
        <div className="mt-8 text-center">
          <p className="text-[10px] tracking-[0.2em] text-[var(--muted-foreground)] uppercase">
            ...
            <button 
              ...
              disabled={isLoading}
              className="text-[var(--primary)] hover:underline focus:outline-none disabled:opacity-50"
            >
